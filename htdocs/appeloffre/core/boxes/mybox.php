...
class mybox extends ModeleBoxes
{
	 ...
	 */
	public $boximg = "appeloffre@appeloffre";
	 ...
	 */
	public $depends = array('appeloffre');
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/appeloffre/class/appeloffre.class.php";
		...
		$this->info_box_head = array(
			...
			'subpicto' => 'object_appeloffre@appeloffre',
